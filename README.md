...
To build server with combined coop and multiplayer maps - remove the filter "*.Objects00p" "Release" "ReleaseXP2" and for coop use copy of "Default.archcfg" as "CoopMode.archcfg"
