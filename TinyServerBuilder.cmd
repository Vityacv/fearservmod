...
robocopy.exe "Archs" "Arch" /NFL /S "*.AnmTree00p" "*.Gamdb00p" "*.Strdb00p" "*.Model00p" "*.Objects00p" "*.World00p" "*.ini" /XF "WorldEdit.ini" /XD "Prefabs" "Release" "ReleaseXP2"
...
(echo %FEAR%.Arch00&echo .)>"%FEARServer%\Default.archcfg"
...
cmd.exe /u /c "echo [General]&echo Version=2&echo Packed=..\%FEARServer%\%FEAR%.Arch00&echo Download=False&echo CRC=False&echo NoCRCFile=True&echo [Folder Include]&echo .=Folders:True,Files:True&echo [Extension Include]&echo Arch00=False&echo Arch00s=False">>"Arch\%FEAR%.Arch00s"
